    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-end">
                <a href="#" class="btn btn-info mr-2" data-toggle="modal" data-target="#cetakba">
                    <span class="text">Cetak BA</span>
                </a>
                <a href="/barang/exportpdfkeluar" class="btn btn-danger mr-2">
                    <span class="text">Export PDF</span>
                </a>
                <a href="/barang/exportexcelkeluar" class="btn btn-success mr-2">
                    <span class="text">Export Excel</span>
                </a>
                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#tambahkeluar">
