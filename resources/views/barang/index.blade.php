...
<form class="navbar-form navbar-left">
    <form class="form-inline my-2 my-lg-0" method="GET" action="/barang">
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                ...
                <div class="right">
                    <a href="/barang/exportpdfbarang" class="btn btn-danger btn-sm">Export PDF</a>
                    <a href="/barang/exportexcelbarang" class="btn btn-success btn-sm">Export Excel</a>
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- <a href="/barang/{{$barang->id}}/edit" class="btn btn-warning btn-sm"><i
